...
class page extends dynamic_form {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'title', get_string('title', 'local_custompage'));
    ...
    public function process_dynamic_submission() {
        ...
        return (new moodle_url('/local/custompage/edit.php', ['id' => $pagepersistent->get('id')]))->out(false);
    }
     ...
     *
     * A {@see \local_custompage\page_access_exception} will be thrown if they can't
     */
